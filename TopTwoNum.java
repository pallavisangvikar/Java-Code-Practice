...
public class TopTwoNum {
	...
	//You should not use any sorting functions. You should iterate the array only once. 
	//You should not use any kind of collections in java.


	public void printTopTwoNums(int[] nums){
        int maxOne = 0;
        int maxTwo = 0;
        for(int n:nums){
            if(maxOne < n){
    ...
    public static void main(String a[]){
        ...
        TopTwoNum ttn = new TopTwoNum();
        ttn.printTopTwoNums(num);
    }
